<?php
/**
 * Fashion Illustrator Role Fields Template
 */

// Get the role data from the config
$role_data = get_domain_role('fashion', 'fashion-illustrator');

if ($role_data):
    $role_key = 'fashion-illustrator';
    ...
    <div class="role-specific-fields" data-role-specific="<?php echo esc_attr($role_key); ?>" style="display: none;">
        ...
        <?php
        // Include the reusable portfolio gallery component
