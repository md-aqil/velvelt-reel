...
.chaitu-register-link:hover {
    color: #dc3545;
}

.chaitu-forgot-link:after,
.chaitu-register-link:after {
    content: '';
    position: absolute;
    width: 0;
    height: 1px;
...
.chaitu-register-link:hover:after {
    width: 100%;
}
    ...
    <div class="chaitu-container">
        ...
        <div class="chaitu-links">
            <div class="chaitu-forgot-password">
                <a href="<?php echo home_url('/forgot-password/'); ?>" class="chaitu-forgot-link">Forgot your
                    password?</a>
            </div>

            <div class="chaitu-register-section">
                <p class="chaitu-register-text">Don't have an account? 
                   <b><a href="<?php echo home_url('/sign-up/'); ?>" class="chaitu-register-link">Create Account</a></b> 
                </p>
