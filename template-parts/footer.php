		...
		<div class="velvet-footer-grid">
			...
			<div class="velvet-footer-col velvet-footer-about">
				<div class="velvet-footer-logo">
					<a href="<?php echo esc_url(home_url('/')); ?>">
						<img src="https://www.thevelvetreel.com/wp-content/uploads/2025/10/velvetreel.png"
							alt="The VelvetReel" class="footer-logo-img"
							onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" />
						<div class="footer-logo-fallback"
							style="display:none; font-size:22px; font-weight:800; color:#ffffff; letter-spacing:1px;">
							THE VELVET REEL
						</div>
					</a>
				</div>
				<p class="velvet-footer-description">
					The VelvetReel is a fashion and film talent platform specialize in discovering, nurturing, and
					showcasing creative individuals-models, actors, filmmakers, designers, and more-who are ready to
				...
				<div class="velvet-footer-socials">
					<a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="16" height="16"
							fill="currentColor">
							<path
								d="M80 299.3V512H196V299.3h86.5l18-97.8H196V137.9c0-26.8 13.1-52.9 55.2-52.9h42.7V0h-68.7C143.5 0 96 49.3 96 128.4v73.1H32v97.8H80z" />
						</svg>
					</a>
			...
			<div class="velvet-footer-col velvet-footer-links">
				...
				<ul class="velvet-footer-menu">
					...
					<li><a href="<?php echo esc_url(home_url('/terms-and-conditions/')); ?>">Terms & Conditions</a>
					</li>
					...
					<li><a href="<?php echo esc_url(home_url('/membership-join/')); ?>">Pricing</a></li>
				</ul>
			</div>
					...
					<div class="velvet-contact-item">
						<div class="velvet-contact-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18"
								fill="currentColor">
								<path
									d="M464 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48zM224 416H64v-32c0-35.35 28.65-64 64-64h32c35.35 0 64 28.65 64 64v32zm-80-128c-35.35 0-64-28.65-64-64s28.65-64 64-64 64 28.65 64 64-28.65 64-64 64zm304 128H288v-32h160v32zm0-64H288v-32h160v32zm0-64H288v-32h160v32z" />
							</svg>
						</div>
					...
					<div class="velvet-contact-item">
						<div class="velvet-contact-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18"
								fill="currentColor">
								<path
									d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6C215.7 335.5 176.5 296.3 132.7 204.3l60.6-49.6a24 24 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6 1H48A24 24 0 0 0 24 25c0 255.5 207.5 463 463 463a24 24 0 0 0 24-24v-74.6a24.16 24.16 0 0 0-13.61-22.6z" />
							</svg>
						</div>
						<div class="velvet-contact-details">
					...
					<div class="velvet-contact-item">
						<div class="velvet-contact-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18"
								fill="currentColor">
								<path
									d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm0 48v40.53l-208 125-208-125V112h416zM48 400V210.3l193.6 116.16a32 32 0 0 0 32.8 0L464 210.3V400H48z" />
							</svg>
						</div>
						<div class="velvet-contact-details">
							<span class="contact-label">Email :</span>
							<a href="mailto:contact@thevelvetreel.com"
								class="contact-value">contact@thevelvetreel.com</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="velvet-footer-col velvet-footer-newsletter">
				...
				<form id="velvet-newsletter-form" class="velvet-newsletter-form" method="post" action="#">
					...
					<div class="velvet-newsletter-msg"
						style="display:none; margin-top:10px; font-size:14px; font-weight:500;"></div>
				</form>
			</div>
