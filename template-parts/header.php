		...
		<div class="velvet-header-actions">
			<?php if ( $is_logged_in ) : ?>
				<div class="user-menu user-profile-capsule">
					<a href="<?php echo esc_url( home_url( '/membership-login/membership-profile/' ) ); ?>" class="user-profile-link" title="<?php echo esc_attr( $current_user->display_name ); ?>">
					...
					<div class="velvet-profile-dropdown">
						<a href="<?php echo esc_url( home_url( '/membership-login/membership-profile/' ) ); ?>">
